      ...
      <div className="p-8">
        ...
        <div className="mb-6">
          <div className="flex items-start gap-4 mb-2">
            ...
            <div className={`flex-shrink-0 w-16 h-16 bg-green-50 border-green-200 border-2 rounded-xl flex items-center justify-center shadow-sm`}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-lg font-semibold text-green-700">{documento.orgaoEmissor}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 pt-6 border-t border-gray-100">
          <div className="bg-gray-50/50 rounded-lg p-3 border border-gray-200">
            <p className="text-xs text-gray-500 mb-1" style={{ fontWeight: 500 }}>Nº Licença</p>
            <div className="flex items-center gap-1.5">
              <Hash className="w-3.5 h-3.5 text-gray-400 flex-shrink-0" />
              <p className="text-sm text-gray-900" style={{ fontWeight: 600 }}>{documento.numeroLicenca}</p>
            </div>
          </div>
